🧩 Meaning OS — Tooling Overview (用途 & 内部構造ガイド)

This document summarizes:

Where the Meaning OS will be used (application domains)

What input the OS receives

What the OS does internally (core / triple / conditions / views)

Safety policies & development priority

Core internal data structures

The unified Meaning OS processing pipeline
